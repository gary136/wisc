...
class MetricBox<D extends Double> implements Parcel <D, D>{
    D volume;
    D weight;
    
    // constructor
    public MetricBox(D volume, D weight) {
        this.volume = volume;
        this.weight = weight;
    }
    public D getVolume() {return this.volume;}
    public D getWeight() {return this.weight;}
}
...
//  3) enable the checks in the main method below to compile and run
class EnglishBox<String, WeightType> implements Parcel <String, WeightType>{
    String volume;
    WeightType weight;
    
    // constructor
    public EnglishBox(String volume, WeightType weight) {
        this.volume = volume;
        this.weight = weight;
    }
    public String getVolume() {return this.volume;}
    public WeightType getWeight() {return this.weight;}
}
...
//  3) enable the checks in the main method below to compile and run
class UniformBox<T> implements Parcel <T, T>{
    T volume;
    T weight;
    ...
    public T getVolume() {return this.volume;}
...
public class GenericsActivity {
    ...
    //  // Checks for the Str MetricBox type:
    //     MetricBox<Double> strm = new MetricBox("x","y");
    //     System.out.println(strm.getVolume());
    //     System.out.println(strm.getWeight());
        
    //  // Checks for the Diff MetricBox type:
    //   UniformBox<String> difu = new UniformBox("x",4.0f);
    //   System.out.println(difu.getVolume());
    //   System.out.println(difu.getWeight());
    }    
}
