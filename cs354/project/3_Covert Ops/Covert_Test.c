...
int Is_Number_Correct(int guess, int ans, int idx) {
    if (guess!=ans) {
        return 0;
    }
    return 1;
...
int f0(int guess, int ans, int idx) {
    
};

int f1(int guess, int ans, int idx) {
    
};

int f2(int guess, int ans, int idx) {
    
};

int f3_helper(int guess, int ans, int idx) {
    
};

int f3(int guess, int ans, int idx) {
